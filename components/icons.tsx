...
export function UsersIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M16 8.5c1.4.3 2.5 1.6 2.5 3.1M19 20c0-2.6-1.7-4.8-4-5.6" />
    </svg>
  );
}
...
export function PaletteIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 3a9 9 0 100 18c1.1 0 2-.9 2-2 0-.5-.2-1-.5-1.4-.3-.4-.5-.9-.5-1.4a2 2 0 012-2h2a4 4 0 004-4c0-4.4-4-7.2-9-7.2z" />
